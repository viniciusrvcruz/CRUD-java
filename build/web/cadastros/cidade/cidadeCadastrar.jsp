...
<form name="cadastrarCidade" action="CidadeCadastrar" method="POST">
    <table align="center" border="0">
        ...
        <tbody>
            <input type="hidden" name="idcidade" id="idcidade" value="${cidade.idCidade}" readonly="readonly">
            <tr>
                <td>Nome: </td>
                <td>
                    <input type="text" name="nomecidade" id="nomecidade" value="${cidade.nomeCidade}" size="50" maxlength="50">
                </td>
            </tr>
            <tr>
                <td>Estado: </td>
